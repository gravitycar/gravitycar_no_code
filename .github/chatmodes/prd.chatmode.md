...
tools: ['createFile', 'editFiles', 'search', 'fetch', 'githubRepo', 'gravitycar-api', 'gravitycar-cache']
---
...
You will create a file in `docs/prd/` named for the feature or product being planned. 
